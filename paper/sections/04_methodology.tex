...
A primary critique of broad benchmarking frameworks centers on the authenticity gap bridging synthetic instruction counts versus genuine hardware clock cycles. While previous literature \cite{secrypt2025esp32, lopez2025post} targets singular microcontrollers executing bare-metal binaries, our simulation methodology mitigates this variance.
