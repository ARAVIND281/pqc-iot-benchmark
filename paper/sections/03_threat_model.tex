...
Our adversary, $\mathcal{A}_{\text{CRQC}}$, is defined as a non-local, passive and active networked entity possessing full intercept, alter, and rerouting capabilities corresponding to the standard Dolev-Yao threat model applied over long-range IoT transmission spectrums (e.g., LoRaWAN, NB-IoT, or wide-area Wi-Fi).
