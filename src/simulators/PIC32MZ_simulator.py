"""
Hardware Physics and Memory Simulator for PIC32MZ.
Architecture: MIPS32 M-Class

This module simulates the explicit execution environment of the PIC32MZ
...
class PIC32MZEmulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "PIC32MZ"
        self.architecture = "MIPS32 M-Class"
        self.clock_freq_mhz = 200
        self.ram_kb = 512
        self.flash_kb = 2048
        self.operating_voltage = 3.3
        self.active_current_ma = 60.0
        self.idle_current_ma = 4.0
