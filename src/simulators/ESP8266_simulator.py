"""
Hardware Physics and Memory Simulator for ESP8266.
Architecture: Tensilica L106

This module simulates the explicit execution environment of the ESP8266
...
class ESP8266Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "ESP8266"
        self.architecture = "Tensilica L106"
        self.clock_freq_mhz = 80
        self.ram_kb = 50
        self.flash_kb = 1024
        self.operating_voltage = 3.3
        self.active_current_ma = 70.0
        self.idle_current_ma = 15.0
