"""
Hardware Physics and Memory Simulator for RISCV_FE310.
Architecture: SiFive E31

This module simulates the explicit execution environment of the RISCV_FE310
...
class RISCV_FE310Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "RISCV_FE310"
        self.architecture = "SiFive E31"
        self.clock_freq_mhz = 320
        self.ram_kb = 16
        self.flash_kb = 16384
        self.operating_voltage = 3.3
        self.active_current_ma = 12.0
        self.idle_current_ma = 0.2
