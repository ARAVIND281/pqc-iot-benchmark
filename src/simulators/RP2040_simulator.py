"""
Hardware Physics and Memory Simulator for RP2040.
Architecture: ARM Cortex-M0+ Dual

This module simulates the explicit execution environment of the RP2040
...
class RP2040Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "RP2040"
        self.architecture = "ARM Cortex-M0+ Dual"
        self.clock_freq_mhz = 133
        self.ram_kb = 264
        self.flash_kb = 2048
        self.operating_voltage = 3.3
        self.active_current_ma = 23.0
        self.idle_current_ma = 1.5
