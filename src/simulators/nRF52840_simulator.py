"""
Hardware Physics and Memory Simulator for nRF52840.
Architecture: ARM Cortex-M4F

This module simulates the explicit execution environment of the nRF52840
...
class nRF52840Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "nRF52840"
        self.architecture = "ARM Cortex-M4F"
        self.clock_freq_mhz = 64
        self.ram_kb = 256
        self.flash_kb = 1024
        self.operating_voltage = 3.0
        self.active_current_ma = 4.8
        self.idle_current_ma = 0.003
