"""
Hardware Physics and Memory Simulator for SAMD21.
Architecture: ARM Cortex-M0+

This module simulates the explicit execution environment of the SAMD21
...
class SAMD21Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "SAMD21"
        self.architecture = "ARM Cortex-M0+"
        self.clock_freq_mhz = 48
        self.ram_kb = 32
        self.flash_kb = 256
        self.operating_voltage = 3.3
        self.active_current_ma = 7.0
        self.idle_current_ma = 0.5
