"""
Hardware Physics and Memory Simulator for MSP430.
Architecture: 16-bit TI

This module simulates the explicit execution environment of the MSP430
...
class MSP430Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "MSP430"
        self.architecture = "16-bit TI"
        self.clock_freq_mhz = 24
        self.ram_kb = 16
        self.flash_kb = 256
        self.operating_voltage = 3.0
        self.active_current_ma = 3.0
