"""
Hardware Physics and Memory Simulator for ATmega2560.
Architecture: 8-bit AVR

This module simulates the explicit execution environment of the ATmega2560
...
class ATmega2560Emulator:
    ...
    def __init__(self, baseline_temp_celsius: float = 25.0):
        self.board_name = "ATmega2560"
        self.architecture = "8-bit AVR"
        self.clock_freq_mhz = 16
        self.ram_kb = 8
        self.flash_kb = 256
        self.operating_voltage = 5.0
        self.active_current_ma = 20.0
        self.idle_current_ma = 2.5
